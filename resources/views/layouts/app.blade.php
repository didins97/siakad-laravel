...
<body class="hold-transition login-page" style="background-image: url('{{ asset("img/wallup.jpg") }}'); background-size: cover; background-attachment: fixed;">
  <div class="login-box">
    ...
    <footer style="color: white;">
      <marquee>
          <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> &diams; <a href="#" style="color: white;">MADRASAH ALIYAH DDI SOREANG KELURAHAN SOREANG KECAMATAN LAU KABUPATEN MAROS</a>. </strong>
      </marquee>
    </footer>
  </div>
